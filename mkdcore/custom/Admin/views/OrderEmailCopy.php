					...
					<div class=" " style="margin-top:1.5rem; margin-bottom:1.5rem; padding:1.5rem;display:flex;justify-content:space-between;">
						<div style="">
							...
							<div style="background-color:#ddd;color:#444;padding:1.5rem;margin-top:1.5rem; margin-bottom:1.5rem; ">
								...
								<div><?php echo $view_model->get_billing_city();?>, <?php echo $view_model->get_billing_zip();?>  </div>
						...
						<div style="font-weight:bold">Shipping Details</div>
							<div style="background-color:#ddd;color:#444;padding:1.5rem;margin-top:1.5rem; margin-bottom:1.5rem; ">
								...
								<div><?php echo $view_model->get_shipping_city();?>, <?php echo $view_model->get_shipping_zip();?>  </div>
								<div><a href='tel:<?php echo $customer->phone?>'> <?php echo $customer->phone?>  </a>  </div>
							</div>
						</div>
					</div>
