...
<div class="tab-content mx-4" id="nav-tabContent">
	...
	<script>
		function printdiv(printpage) {
			...
			var headstr = "<html><head><title></title><style type='text/css'>@media print {.make_font_big{font-size: 15px !important;padding:0px !important;word-spacing: 50px !important;width : 100% !important;}}</style></head><body>";
