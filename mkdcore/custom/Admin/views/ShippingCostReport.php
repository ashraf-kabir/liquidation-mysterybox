...
<h5 class="primaryHeading2 d-flex justify-content-between mt-2 my-4">
  ...
  <span class="add-part d-flex justify-content-md-end  "><a class="btn btn-info btn-sm ml-2" href="<?php echo base_url().'admin/shipping_cost_report/to_csv?'.$QUERY_STRING; ?>"><i class="fas fa-file-download" style="color:white;"></i></a></span>
</h5>
