...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card" id="Inventory_Location_filter_listing">
            <div class="card-body">
              <h5 class="primaryHeading2 text-md-left">
                    <?php echo $view_model->get_heading();?> Search
              </h5>
                <?= form_open('/admin/inventory_location/0', ['method' => 'get']) ?>
                    <div class="row">
...
<h5 class="primaryHeading2 d-flex justify-content-between mt-2 my-4">
  ...
  <span class="add-part d-flex justify-content-md-end"><a class="btn btn-primary btn-sm" target="_blank" href="/admin/inventory_location/add"><i class="fas fa-plus-circle"></i></a></span>
</h5>
            ...
            <?php foreach ($view_model->get_list() as $data) { ?>
                <?php
                    echo '<tr>';
							...
							echo "<td>{$data->store->name}</td>";
							echo '<td>';
							echo '<a class="btn btn-link  link-underline text-underline  btn-sm" target="_blank" href="/admin/inventory_location/edit/' . $data->id . '">Edit</a>';
							echo ' <a class="btn btn-link  link-underline text-underline btn-sm" target="_blank" href="/admin/inventory_location/view/' . $data->id . '">View</a>';
							echo ' <a class="btn btn-link  link-underline text-underline text-danger btn-sm" target="_blank" href="/admin/inventory_location/delete/' . $data->id . '">Remove</a>';
							echo '</td>';
                    echo '</tr>';
                ?>
            <?php } ?>
