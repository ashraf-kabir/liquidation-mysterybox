...
<h5 class="primaryHeading2 d-flex justify-content-between mt-2 my-4">
  ...
  <span class="add-part d-flex justify-content-md-end"><a class="btn btn-primary btn-sm" target="_self" href="/admin/subcategory/add"><i class="fas fa-plus-circle"></i></a></span>
</h5>
...
<?php
  echo '<tr>';
    ...
    echo '<td>';
    echo '<a class="btn btn-link  link-underline text-underline  btn-sm" target="_self" href="/admin/subcategory/edit/' . $data->id . '">Edit</a>';
    echo ' <a class="btn btn-link  link-underline text-underline btn-sm" target="_self" href="/admin/subcategory/view/' . $data->id . '">View</a>';
    echo ' <a class="btn btn-link  link-underline text-underline text-danger btn-sm" target="_self" href="/admin/subcategory/delete/' . $data->id . '">Remove</a>';
