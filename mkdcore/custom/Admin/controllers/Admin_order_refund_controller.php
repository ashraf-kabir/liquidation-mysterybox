...
class Admin_order_refund_controller extends Admin_controller
{
  ...
  private function notify_customer_about_refund($order_id)
  {
    ...
    $text_msg = "Your order has been shipped and your tracking number is <a target='_self' href='https://www.google.com/search?q={$tracking_no}'>" . $tracking_no . "</a>.<br> You can track order <a href='https://www.google.com/search?q=" . $tracking_no . "' target='_self' style='color;#1A73E8 !important;' >here</a>";
