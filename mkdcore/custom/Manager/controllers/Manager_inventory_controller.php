 ...
 *
 */
class Manager_inventory_controller extends Manager_controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            return $this->render('Manager/InventoryAdd', $this->_data);
        }
        ...
        if ($result) {
            ...
            return $this->redirect('/manager/inventory/skus/' . $sku_ids . '?print=1');
        }
    ...
    public function transfer_inventory()
    {
        ...
        if (isset($_POST['submit_inventory_transfer'])) {
            ...
            if (count($_sku) < 1) {
                ...
                return redirect('/manager/transfer/transfer_inventory/');
            }
        ...
        return $this->render('Manager/InventoryTransfer', $this->_data);
    }
