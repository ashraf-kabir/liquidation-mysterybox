 ...
 *
 */
class Manager_transactions_controller extends Manager_controller
{
    ...
    public function index($page)
	{
        ...
        $this->_data['view_model']->set_sort_base_url('/manager/transactions/0');
    ...
    public function view($id)
	{
		...
		{
			$this->error('Error');
			return redirect('/manager/transactions/0');
		}
		...
		return $this->render('Manager/TransactionsView', $this->_data);
	}
