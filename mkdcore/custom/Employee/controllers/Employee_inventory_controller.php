 ...
 *
 */
class Employee_inventory_controller extends Employee_controller
{
    ...
    public function index($page)
    {
        ...
        include_once __DIR__ . '/../../view_models/Inventory_employee_list_paginate_view_model.php';
        $session = $this->get_session();
        $format = $this->input->get('format', TRUE) ?? 'view';
        $order_by = $this->input->get('order_by', TRUE) ?? '';
        $direction = $this->input->get('direction', TRUE) ?? 'ASC';

        $this->_data['view_model'] = new Inventory_employee_list_paginate_view_model(
        ...
        $this->_data['view_model']->set_sort_base_url('/employee/inventory/0');
        ...
        return $this->render('Employee/Inventory', $this->_data);
    }
    ...
    public function add()
    {
        ...
        $this->_data['view_model'] = new Inventory_employee_add_view_model($this->inventory_model);
        $this->_data['view_model']->set_heading('Inventory');
        ...
        if ($this->form_validation->run() === FALSE) {
            return $this->render('Employee/InventoryAdd', $this->_data);
        }
    ...
    //     if (!$model) {
    //         $this->error('Error');
    //         return redirect('/employee/inventory/0');
    //     }

    //     include_once __DIR__ . '/../../view_models/Inventory_employee_edit_view_model.php';
    //     $this->form_validation = $this->inventory_model->set_form_validation(
    //         $this->form_validation,
    //         $this->inventory_model->get_all_edit_validation_rule()
    //     );
    //     $this->_data['view_model'] = new Inventory_employee_edit_view_model($this->inventory_model);
    ...
    //     if ($this->form_validation->run() === FALSE) {
    //         return $this->render('Employee/InventoryEdit', $this->_data);
    //     }
    ...
    //         return $this->redirect('/employee/inventory/0', 'refresh');
    //     }
    ...
    public function view($id)
    {
        ...
        include_once __DIR__ . '/../../view_models/Inventory_employee_view_view_model.php';
        $this->_data['view_model'] = new Inventory_employee_view_view_model($this->inventory_model);
        $this->_data['view_model']->set_heading('Inventory');
        ...
        return $this->render('Employee/InventoryView', $this->_data);
    }
