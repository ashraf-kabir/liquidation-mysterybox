...
<div class="tab-content mx-4" id="nav-tabContent">
    ...
    <section>
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card" id="InventoryReport_filter_listing">
                    <div class="card-body">
                        <h5 class="primaryHeading2 text-md-left">
                            <?php echo $view_model->get_heading(); ?> Search
                        </h5>
                        <?= form_open('/employee/inventory_report/0', ['method' => 'get']) ?>
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="category_id" name="category_id">
                                        ...
                                        <?php foreach ($categories as $key => $value) : ?>
                                            <option <?php if ($this->_data['view_model']->get_category_id() == $value->id) : ?> selected <?php endif ?> value="<?php echo $value->id; ?>"><?php echo $value->name; ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
    ...
    <h5 class="primaryHeading2 d-flex justify-content-between mt-2 my-4">
        ...
        <span class="add-part d-flex justify-content-md-end  "><a class="btn btn-info btn-sm ml-2" href="<?php echo base_url() . 'admin/inventory_report/to_csv?' . $QUERY_STRING; ?>"><i class="fas fa-file-download" style="color:white;"></i></a></span>
    </h5>
