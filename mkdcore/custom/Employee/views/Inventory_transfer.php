...
<div class="tab-content mx-4" id="nav-tabContent">
    ...
    <h5 class="primaryHeading2 d-flex justify-content-between mt-2 my-4">
        ...
        <span class="add-part d-flex justify-content-md-end"><a class="btn btn-primary btn-sm" target="_blank" href="/manager/transfer/transfer_inventory"><i class="fas fa-plus-circle"></i></a></span>
    </h5>
            ...
            <table class="table br w-100">
                ...
                <tbody class="tbody-light">
                    <?php foreach ($view_model->get_list() as $data) { ?>
                        ...
                        echo ' <a class="btn btn-link  link-underline text-underline btn-sm" target="_blank" href="/manager/inventory_transfer/view/' . $data->id . '">View</a>';
