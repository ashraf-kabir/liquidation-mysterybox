...
document.addEventListener(
    ...
    function () {
            ...
            $.ajax({
                ...
                for (var i = 0; i < items.length; i++) {
                    ...
                    $("#mkd-media-gallery-wrapper").append(
                        '<div class="col-lg-2 col-6 mb-2"><img data-id="' +
                        element.id +
                        '" data-video="' +
                        element.video +
                        '" src="' +
        ...
        $(document).on("click", ".mkd-gallery-image-image-2", function () {
            ...
            .parent()
            .parent()
            .find(".youtube-image-delete-close").remove();
            ...
            this_image_object
            .parent()
            .find(".output_youtube_thumbnail_1")
            .attr("src", img_src_id);
...
$.ajax({
    ...
    success: function (data) {
        ...
        this_image_object
        .parent()
        .find(".youtube_thumbnail_1")
        .val(data.file);
        this_image_object
        .parent()
        .find(".youtube_thumbnail_1_id")
        .val(data.id);
    },
});
};
