    ...
    <div class="row ">
        <div class="col-12 col-md-10 mt-4 padding-left-0-custom add_margin_mobile">
            <div class="product__pathLink"><a href="<?php echo base_url() ?>">Home ></a>
                ...
                <b style="color:black;"><?php echo $product->product_name; ?></b>
            </div>
        </div>
    </div>
</main>
                ...
                <div class="row col-12 col-sm-12 image-container">
                    ...
                    <?php if (!empty($product->feature_image)) {   ?>
                        <div class="mySlides img col-10">
                            ...
                            <img src="<?php echo $product->feature_image; ?>" class="img-thumbnail img-fluid img-responsive main-img" style="width:100%" alt="<?php echo $product->product_name; ?>">
                        </div>
                    <?php } else { ?>
                        <div class="mySlides img col-10">
                            <div class="numbertext">1 / <?php echo $gallery_image_count ?></div>
                            <img class="img-thumbnail img-fluid img-responsive main-img" src="/assets/frontend_images/noun_pallet_box_1675914.png" style="width:100%" alt="<?php echo $product->product_name; ?>">
                        </div>
                    <?php } ?>
                    <?php if (!empty($gallery_lists)) : $k = 2; ?>
                        <?php foreach ($gallery_lists as $key => $value) : ?>
                            <div class="mySlides img col-10">
                                ...
                                <img class="img-thumbnail img-fluid img-responsive main-img" src="<?php echo $value->image_name; ?>" style="width:100%" alt="<?php echo $product->product_name; ?>">
                            </div>
                        <?php endforeach ?>
                    <?php endif ?>
        ...
        <div class="col-lg-5 col-991-p-0 mt-4 pr-md-0">
            <div class="bg-white w-100 p-2 px-md-4 d-flex justify-content-center " style="padding-top: 0.5rem !important;    padding-bottom: 1px !important;">
                <ul class="list-unstyled text-center" style="margin: 0px;">
                    ...
                    <li class="my-1 ">
                        <h4 style="width: 100%;"><?php echo $product->product_name; ?></h4>
                    </li>
            ...
            <?php if ($product->quantity > 0) { ?>
                <?php if ($product->can_ship != 3) /* 3 - shipping only */ : ?>
                    ...
                    <div class="bg-white w-100 p-2 px-md-4 " style="display:none" id="store-component" pickup="<?php echo ($product->can_ship == 2 && $product->can_ship_approval != 1) ? 'true' : ''; ?>">
                        <?php if (count($store_inventory) > 0) : ?>
                                            ...
                                            <div class="swiper-slide swiper-slide-liquidation">
                                                ...
                                                <div class="video-container col-12 col-md-12 col-lg-12" style="padding: 20px 10px; ">
                                                    ...
                                                    <a href="<?php echo $videos_data[$count]; ?>" target="_blank">
                                                        ...
                                                        <img style="border: none;" class="img-thumbnail image-fit-in-div videos-thumbnail" src="<?php echo $images_data[$count]; ?>" />
                                                    </a>
                                                </div>
...
<script>
    ...
    function showSlides(n) {
        ...
        for (i = 0; i < dots.length; i++) {
            ...
            dots[i].closest('.testing').className = dots[i].closest('.testing').className.replace(" bordered", "");
        }
    ...
    const btns = document.querySelectorAll('.img-controller');
