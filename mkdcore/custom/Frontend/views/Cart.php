                    ...
                    foreach ($cart_items as $key => $value) {
                        ...
                        <div class="row cart__addedItem justify-content-between mb-4 p-2" style="background-color: white;">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-4 col-12 my-3 d-flex align-content-between flex-wrap">
                                ...
                                <label for="quantity">
                                    Qty:
                                    <input type="text" data-itm-pid="<?php echo $value->product_id ?>" name="quantity" class="quantity_value form-control w-50 text-center" value="<?= $value->product_qty; ?>" />
                                </label>
                                <h5>
                ...
                <div style=" background-color: white;  padding-top: 7px;">
                    ...
                    <div class="cart__summary px-4 py-4">
                        ...
                        <?php if (count($cart_items) >  0) : ?>
                            <a <?php if ($this->session->userdata('customer_login')) : ?> href="<?php echo base_url(); ?>checkout" <?php else : ?> data-target="#loginModal" data-toggle="modal" <?php endif; ?> style="line-height:2;" class="btn btn-success w-100  mb-4 check_out_1">Checkout</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
