        ...
        { 
            ...
            if(isset($params['tracking_no']) and !empty($params['tracking_no']))
            {
                ...
                if ($order_data) 
                {
                    ...
                    $text_msg = "Your order has been shipped and your tracking number is " . $tracking_no . ".<br> You can track order <a href='https://www.google.com/search?q=" . $tracking_no . "' target='_blank' style='color;#1A73E8 !important;' >here</a>"; 
