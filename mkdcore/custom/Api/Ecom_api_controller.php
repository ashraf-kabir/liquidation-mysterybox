...
class Ecom_api_controller extends Manaknight_Controller
{
  ...
  public function update_order_status()
  {
    ...
    if (isset($params) && !empty($params)) {
      if (isset($params['sale_order_id']) && empty($params['sale_order_id'])) {
        $output['error']     = TRUE;
      ...
      if (isset($params['tracking_no']) && !empty($params['tracking_no'])) {
        ...
        if ($order_data) {
          ...
          $text_msg = "Your order has been shipped and your tracking number is <a target='_self' href='https://www.google.com/search?q={$tracking_no}'>" . $tracking_no . "</a>.<br> You can track order <a href='https://www.google.com/search?q=" . $tracking_no . "' target='_blank' style='color;#1A73E8 !important;' >here</a>";
