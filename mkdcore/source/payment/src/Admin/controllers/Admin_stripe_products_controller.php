...
class Admin_stripe_products_controller extends Admin_controller
{
	...
	public function index($page)
	{
        ...
        include_once __DIR__ . '/../../view_models/Stripe_products_admin_list_paginate_view_model.php';
        ...
        return $this->render('Admin/Stripe_products', $this->_data);
	}

	public function add()
	{
        include_once __DIR__ . '/../../view_models/Stripe_products_admin_add_view_model.php';
		...
		{
			return $this->render('Admin/Stripe_productsAdd', $this->_data);
        }
        ...
        $this->_data['error'] = 'xyzError Creating Stripe Product';
        return $this->render('Admin/Stripe_productsAdd', $this->_data);
	...
	public function edit($id)
	{
		...
		{
			$this->error('Error');
			return redirect('/admin/stripe_products/0');
        }

        include_once __DIR__ . '/../../view_models/Stripe_products_admin_edit_view_model.php';
        $this->form_validation = $this->stripe_products_model->set_form_validation(
        $this->form_validation, $this->stripe_products_model->get_all_edit_validation_rule());
        $this->_data['view_model'] = new Stripe_products_admin_edit_view_model($this->stripe_products_model);
		...
		if ($this->form_validation->run() === FALSE)
		{
			return $this->render('Admin/Stripe_productsEdit', $this->_data);
        }
	...
	public function view($id)
	{
        ...
        include_once __DIR__ . '/../../view_models/Stripe_products_admin_view_view_model.php';
		$this->_data['view_model'] = new Stripe_products_admin_view_view_model($this->stripe_products_model);
		$this->_data['view_model']->set_heading('Products');
        $this->_data['view_model']->set_model($model);
        
		return $this->render('Admin/Stripe_productsView', $this->_data);
	}
