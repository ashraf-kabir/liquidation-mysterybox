            ...
            <div class="card-body">
                ...
                <?= form_open() ?>
                    <div class="form-group col-md-5 col-sm-12">
				    	...
				    	<input type="text" class="form-control data-input" id="form_display_name" name="display_name" value="<?php echo set_value('display_name', $this->_data['view_model']->get_display_name());?>"/>
				    </div>
				    <div class="form-group col-md-5 col-sm-12">
