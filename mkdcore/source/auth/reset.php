        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-10 col-xs-10 p-5 auth-wrap">
                ...
                <div class="form-container p-5">
                     <form action="/{{{portal}}}/reset/<?php echo $reset_token;?>" method='POST'>
                        ...
                        <div class="form-group text-container">
                            <label class='required' for="Email">xyzConfirm Password </label>
                            <input name="confirm_password" type="password" class="form-control site-input"  required="true">
                        </div>
                        <div class="form-group">
                            <input type="submit" name='btn-login' class="btn btn-accent-light btn-block" value="xyzReset">
                        </div>
                    </form>
