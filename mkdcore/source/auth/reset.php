...
<body>
    <div id="mkd-login-container">
        <form action="/{{{portal}}}/reset/<?php echo $reset_token;?>"  method="POST" class="mkd-reset-form-container">
            <h1 class="h3 mb-3 font-weight-normal text-center"> xyzReset Password</h1>
            <input name="password" type="password" class="form-control" placeholder="xyzPassword" required="true">
            <input name="confirm_password" type="password" class="form-control" placeholder="xyzRepeat Password" required="true">
