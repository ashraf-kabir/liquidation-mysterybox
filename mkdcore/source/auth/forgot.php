...
<head>
    ...
    <title>{{{title}}} | xyzForgot Password</title>
</head>
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a style='color: #FBFDFF;' class="nav-link" href="/{{{portal}}}/login">  Login</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="form-container p-5">
                    <?php echo form_open('/{{{portal}}}/forgot');?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control site-input" placeholder="Email address" required="true" autofocus="true">
                        </div>
                        <div class="form-group">
                            <input type="submit" name='btn-login' class="btn btn-accent-light btn-block" value="xyzReset Password">
                        </div>
                    </form>
